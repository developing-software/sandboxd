...
type SecurityHandler interface {
	...
	// SANDBOXD_SERVICE_TOKEN today, the same one the client API takes. The operator surface earning its
	// own token is a change here and nowhere else.
...
var operationRolesBearer = map[string][]string{
	ApproveHostOperation: []string{},
	ListHostsOperation:   []string{},
	RevokeHostOperation:  []string{},
}
