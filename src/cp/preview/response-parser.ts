...
import { concat, findCRLF, findCRLF2 } from "../../shared/bytes.ts";

export type ParseEvent = { kind: "head"; status: number; headers: Headers } | { kind: "body"; data: Uint8Array } | { kind: "end" };
