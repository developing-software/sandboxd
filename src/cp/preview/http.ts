...
import type { PortHandle } from "../hosts/conn.ts";
import { ResponseParser } from "./response-parser.ts";
import { concat } from "../../shared/bytes.ts";
...
export interface UpstreamResponse { conn: Upstream; status: number; headers: Headers }
